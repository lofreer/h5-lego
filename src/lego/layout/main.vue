<template>
  <div class="lego-body">
    ...
    <div class="lego-option">
      ...
      <lego-page-opt v-else :option="pageConfig"></lego-page-opt>
    </div>
...
import legoSidebar from './sidebar.vue'
import legoToolbar from './toolbar.vue'
import legoPageOpt from './pageOption.vue'
// 页面默认配置
